...
export default function CreateBookingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { data, error } = await apiRequest("/api/bookings", {
      method: "POST",
    ...
    router.push("/admin_panel/bookings")
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground tracking-tight">Create Booking</h1>
          <p className="text-muted-foreground mt-1">Manually create a new booking</p>
        </div>
      </div>
